...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox('enrol_extendedguest/defaultenrol',
    ...
    $settings->add(new admin_setting_configcheckbox('enrol_extendedguest/localnet',
        get_string('localnet', 'enrol_extendedguest'), null, 1));

    $settings->add(new admin_setting_configcheckbox('enrol_extendedguest/authenticated_users',
        get_string('authenticated_users', 'enrol_extendedguest'), null, 1));
}